...
urlpatterns = [
    url(r'^auth/$',
        auth.AuthView.as_view({'get': 'login', 'post': 'auth'}), name='auth'),

    url(r'^customer/list/$', customer.customer_list, name='customer_list'),
    url(r'^customer/add/$', customer.customer_add, name='customer_add'),
    url(r'^customer/edit/(?P<cid>\d+)/$',
        customer.customer_edit, name='customer_edit'),
    url(r'^customer/del/(?P<cid>\d+)/$',
        customer.customer_del, name='customer_del'),
    ...
    url(r'^payment/edit/(?P<pid>\d+)/$',
        payment.payment_edit, name='payment_edit'),
